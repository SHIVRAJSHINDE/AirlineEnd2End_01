...
class cleaning:
    def __init__(self):
        pass
    def readData(self):
        filePath ="E:/1.Eathans/Ethans/Data/Airline/Airline1.csv"
    ...
    def Train_Test_Split(self, X,y):
        ...
        X_train.to_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/X_train.csv",index=False) 
        X_test.to_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/X_test.csv",index=False) 
        y_train_true.to_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/y_train_true.csv",index=False)  
        y_test_true.to_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/y_test_true.csv",index=False)
