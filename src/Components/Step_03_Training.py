...
class Training:
    ...
    def read_Data(self):
        X_test = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/X_test.csv")
        X_train = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/X_train.csv")
        y_test_true = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/y_test_true.csv")
        y_train_true = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/CleanedData/y_train_true.csv")

        X_train_trans = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/Trans_data/X_train_trans.csv")
        X_test_trans = pd.read_csv("E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Data/Trans_data/X_test_trans.csv")
    ...
    def ModelTraining(self,X_train,X_train_trans,y_train_true):
        ...
        for Model_Name,Model in self.models.items():
            ...
            joblib.dump(best_model_instance,f"E:/1.Eathans/Final Projects/AirlineEnd2End_01/Artifact/Model_File/{Model_Name}.pkl")
            print(Model_Name)
